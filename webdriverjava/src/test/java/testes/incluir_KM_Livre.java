...
public class incluir_KM_Livre {
    ...
    private String diaDevAlt="21", mesDevAlt="03", anoDevAlt="2019";
    ...
    public void setUp() {
        ...
        navegador.get(link);
        //navegador.get("http://localhost:55572/");
...
//    }
    ...
    public void ReservaLivre() throws InterruptedException {
        ...
        nomeArquivo = "C:\\TesteAutomatizado\\RACunidas\\ReservaKMLivre\\RAC" + Generator.dataHoraParaArquivo()+ test.getMethodName() + ".png";
    ...
    public void ConsultarReserva() throws InterruptedException{
        ...
        //  navegador.get("https://unidas.com.br/minhas-reservas");
        Thread.sleep(3000);
        navegador.findElement(By.id("input-cpf-passport")).sendKeys(docCli);
       // navegador.findElement(By.id("cpf-passport")).sendKeys(docConsulta);
        ...
        while (contador < 1) {
            nomeArquivo = "C:\\TesteAutomatizado\\RACunidas\\ReservaKMLivre\\RAC" + Generator.dataHoraParaArquivo() + test.getMethodName() + "minhas_reservas.png";
            ScreenShot.tirar(navegador, nomeArquivo);
            Thread.sleep(1500);
            contador = contador + 1;
        }
    ...
    public void AlterarReserva() throws InterruptedException{
        ...
        nomeArquivo = "C:\\TesteAutomatizado\\RACunidas\\ReservaKMLivre\\RAC" + Generator.dataHoraParaArquivo()+ test.getMethodName() + "tela_minhasReservas.png";
        ScreenShot.tirar(navegador, nomeArquivo);
    ...
    public void CancelarReserva() throws InterruptedException{
        ...
        Thread.sleep(1000);
        nomeArquivo = "C:\\TesteAutomatizado\\RACunidas\\ReservaKMLivre\\RAC" + Generator.dataHoraParaArquivo()+ test.getMethodName() + "cancelada.png";
        ScreenShot.tirar(navegador, nomeArquivo);
...
//tag[@parametro="condição"]
//tag[@parametro="condição"]//tag[@parametro="condição"]
////input[@data-title="Cadeira de Bebê"]/ancestor::label//span[@class="in"]
////input[@data-title="Cadeira de Bebê"]/ancestor::label//span[@class="in"]/ancestor::div[@class="box--add__actions box--add__actions--single active"]//button[@class="plus"]
